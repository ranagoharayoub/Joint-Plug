        ...
        <div className="details-cont" style={active==='detail' ? { display: 'flex'}: {display:'none'}}>
            <div className="detail-sect">
                ...
                <div className="detail-sect-right">
                    ...
                    <p className="section-details-right"><i class="fab fa-facebook-f"></i>&#9;FaceBook</p>
                    <p className="section-details-right"><i class="fab fa-instagram"></i>&#9;Instagram</p>
                    <p className="section-details-right"><i class="fab fa-twitter"></i>&#9;Twitter</p>
                </div>
            </div>
        </div>
    )
